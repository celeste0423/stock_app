...
FAST_DB_PATH = Path("D:/Study/stock app/backend/asia_stock_daily_fast.sqlite")
FAST_PARQUET_PATH = Path("D:/Study/stock app/backend/asia_stock_daily_fast.parquet")
